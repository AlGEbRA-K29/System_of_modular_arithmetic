...
void TestFunc4() {
	...
	//func use polard algo, crush
        // std::cerr << "Eurel and Carmaicle" << std::endl;
		...
		// AssertEqual(tmp1, carmaicle(vec, vec.size()));
		// AssertEqual(tmp2, eurel(vec, vec.size()));
		...
		// AssertEqual(tmp3, carmaicle(vec2, vec2.size()));
		// AssertEqual(tmp4, eurel(vec2, vec2.size()));
		...
		// AssertEqual(tmp5, carmaicle(vec3, vec3.size()));
		// AssertEqual(tmp6, eurel(vec3, vec3.size()));
		...
		// AssertEqual(tmp7, carmaicle(vec4, vec4.size()));
		// AssertEqual(tmp8, eurel(vec4, vec4.size()));
		...
		// AssertEqual(tmp9, carmaicle(vec5, vec5.size()));
		// AssertEqual(tmp10, eurel(vec5, vec5.size()));
	//crush
        // std::cerr << "Finding the order and ch" << std::endl;

		// AssertEqual(find_order(2, 5), 4);
		// AssertEqual(find_order(3, 100), 20);
		// AssertEqual(find_order(2, 4), 0);
		// AssertEqual(find_order(3, 12344), 514);
		// AssertEqual(find_order(5, 101204), 6325);
		// AssertEqual(find_order(3, 101203), 33734);
		// AssertEqual(isGenerator(3, 101), 1);
		// AssertEqual(isGenerator(5, 109), 0);
